...
This was my first time with the AG Grid tool, big documentation but so far a great, complex and useful Library, that been said, I had issues with task #5, apparently some features are exclusive for the licensed use and after doing some research I couldn't find the proper solution for the task.
